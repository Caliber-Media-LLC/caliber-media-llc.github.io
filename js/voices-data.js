...
var CALIBER_VOICES = [
  ...
  { name: 'The Shipwright',     img: 'the-shipwright.jpg', samples: ['shipwright-1.mp3', 'shipwright-2.mp3'],             gender: 'Male',   rating: 'R', genres: ['Survival', 'RPG'],
  ...
  { name: 'Ironside',           img: 'ironside.jpg', samples: ['ironside-1.mp3', 'ironside-2.mp3'],                       gender: 'Male',   rating: 'R', genres: ['Survival', 'RPG'],
    games: ["Valheim", "Assassin's Creed Valhalla", "God of War"],
    desc: 'Few words. Big axe. Keeps walking. Curses in Norse/Norwegian.' },
  { name: 'The Boneless',       img: 'the-boneless.jpg', samples: ['boneless-1.mp3', 'boneless-2.mp3'],                   gender: 'Male',   rating: 'R', genres: ['Survival', 'RPG', 'Strategy'],
  ...
  { name: 'Kurogane Hayato',    img: 'kurogane-hayato.jpg',                                                               gender: 'Male',   rating: 'PG-13',     genres: ['Samurai', 'Strategy', 'Survival'],
