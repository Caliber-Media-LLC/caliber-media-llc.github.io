...
var CALIBER_VOICES = [
  ...
  { name: 'The Wanderer',       img: 'the-wanderer.jpg', samples: ['wanderer-1.mp3', 'wanderer-2.mp3'],                   gender: 'Male',   rating: 'PG-13', genres: ['Survival', 'RPG'],
    games: ["Valheim", "Assassin's Creed Valhalla"],
  ...
  { name: 'The Boneless',       img: 'the-boneless.jpg', samples: ['boneless-1.mp3', 'boneless-2.mp3'],                   gender: 'Male',   rating: 'PG-13', genres: ['Survival', 'RPG'],
    games: ["Valheim", "Assassin's Creed Valhalla"],
