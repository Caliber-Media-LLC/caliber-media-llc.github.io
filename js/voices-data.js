...
var CALIBER_VOICES = [
  ...
  { name: 'The Wanderer',       img: 'the-wanderer.jpg', samples: ['wanderer-1.mp3', 'wanderer-2.mp3'],                   gender: 'Male',   rating: 'PG-13', genres: ['Survival'],
    games: ["Valheim"],
    desc: 'A Viking explorer-king. Calm, dry and always looking past the horizon.' },
  { name: 'The Shieldmaiden',   img: 'the-shieldmaiden.jpg', samples: ['shieldmaiden-1.mp3', 'shieldmaiden-2.mp3'],       gender: 'Female', rating: 'PG-13', genres: ['Survival'],
    games: ["Valheim"],
    desc: 'Holds the line and guards the hall. Swears in Norwegian.' },
  { name: 'The Shipwright',     img: 'the-shipwright.jpg', samples: ['shipwright-1.mp3', 'shipwright-2.mp3'],             gender: 'Male',   rating: 'PG-13', genres: ['Survival'],
    games: ["Valheim"],
    desc: 'A giggling boat-builder who talks to the gods. They talk back.' },
  { name: 'Ironside',           img: 'ironside.jpg', samples: ['ironside-1.mp3', 'ironside-2.mp3'],                       gender: 'Male',   rating: 'PG-13', genres: ['Survival'],
    games: ["Valheim"],
    desc: 'Few words. Big axe. Keeps walking.' },
  { name: 'The Boneless',       img: 'the-boneless.jpg', samples: ['boneless-1.mp3', 'boneless-2.mp3'],                   gender: 'Male',   rating: 'PG-13', genres: ['Survival'],
    games: ["Valheim"],
    desc: 'A ruthless young warlord. His mind is the weapon.' },
